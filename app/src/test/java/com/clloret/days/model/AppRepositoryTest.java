...
import com.clloret.days.ImmediateSchedulersRule;
import com.clloret.days.RestServiceTestHelper;
...
@Category({com.clloret.days.MediumTest.class})
...
public class AppRepositoryTest {
  ...
  public void editEvent_Always_EditValueInLocalDataStore() throws Exception {
    ...
    assertThat(testObserver.values(), contains(allOf(hasProperty("name",
        is(createdEvent.getName())))));
  }
